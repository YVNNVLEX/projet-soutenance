      ...
      <div className="flex flex-1 flex-col gap-4 p-4">
        ...
        <div className="min-h-[50vh] flex-1 rounded-xl bg-muted/50 md:min-h-min p-6">
          ...
          <div className="mt-6 flex justify-center">
            <Link href="/praticien/consultations" className="flex items-center gap-5 px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors"
